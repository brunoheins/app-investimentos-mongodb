...
def tela_acesso():
    ...
    # 1. Sem st.empty()! Renderizamos direto na tela.
    ...
    with col2:
        ...
        with tab_login:
            with st.form("form_login"):
                ...
                # 2. Corrigido para use_container_width=True
                    ...
                    if agora - st.session_state.last_login_time < 3:
                        ...
                        if usuario:
                            ...
                            if status_usuario == 'Ativo':
                                ...
                                st.cache_data.clear() 
                                st.rerun() # <-- Apenas o rerun faz a transição nativa e limpa!
        ...
        with tab_cadastro:
            with st.form("form_cadastro", clear_on_submit=True):
                ...
                # 3. Corrigido para use_container_width=True
